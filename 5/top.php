...
<div id="bar">
	<div id="container">
        ...
        <table border="0" cellpadding="0" cellspacing="0" id="arama">
            <tr><td>&nbsp;</td><td><div class="input"><input type="text" name="was" id="wastxtbx" onkeyup="searchFull(this.value)"
            													value="<?=((isset($_GET['was']))?$_GET['was']:'');?>"  /></div></td>
            	<td style="width:200px;"></td>
                <td>&nbsp;</td><td><div class="input"><input type="text" name="wo" id="wotxtbx" onkeyup="searchOther(this.value)"
